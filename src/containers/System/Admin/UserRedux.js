...
class UserRedux extends Component {
    ...
    handleOnchangImage = async (event) => {
        ...
        if (file) {
            ...
            console.log("check base63:   ", base64);
    ...
    checkValidateInput = () => {
        ...
        for (let i = 0; i < arrCheck.length; i++) {
            if (!this.state[arrCheck[i]]) {
                isValid = false;
                alert('Please enter the field: ' + arrCheck[i])
                break;
            }
        }
        return isValid;
    ...
    render() {
        ...
        // cải tiến lấy dữ liệu

        let {
            email, password, firstName, lastName, address,
            gender, phoneNumber, role, avatar, position
        } = this.state
        return (
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-12 mb-5'>
                                <TableManageUser
                                    // chuyền function cho thằng con tableManageUser
